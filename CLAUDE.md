...
- ✅ **Event Lifecycle Status** - система статусов событий (upcoming/ongoing/completed/cancelled)
- ✅ **Отмена событий** - функционал отмены с уведомлениями участникам
- ✅ **Telegram Mini App** - автоматическая авторизация через бота [@ObschiySbor_bot](https://t.me/ObschiySbor_bot)
- ✅ **Telegram Login Widget** - вход через Telegram в браузере
...
**Документация:**
- [DATABASE_EVENT_LIFECYCLE_STATUS.md](DATABASE_EVENT_LIFECYCLE_STATUS.md) - ⭐ **НОВОЕ** Система статусов событий
