...
- ✅ **Система слияния аккаунтов** (2025-01-27) ⭐ **НОВОЕ**
  - Поиск потенциальных дубликатов аккаунтов
  - Автоматический перенос всех данных (события, участия, отзывы, XP)
  - MergeAccountsPanel компонент с подтверждением
...
- [docs/features/ACCOUNT_MERGING_SYSTEM.md](docs/features/ACCOUNT_MERGING_SYSTEM.md) - ⭐ Система слияния аккаунтов (НОВОЕ)
- [docs/features/PROMO_CODE_SYSTEM.md](docs/features/PROMO_CODE_SYSTEM.md) - Система промокодов
