    ...
    <div className="about-page">
      ...
      <div className="about-content">
        <section className="about-section">
          ...
          <h2>Наша миссия</h2>
          <p>
            Мы создали ObschiySbor, чтобы объединять людей вокруг общих интересов.
        ...
        <section className="about-section about-cta">
          {user ? (
            <>
              ...
              <p>
                Мы рады, что вы используете ObschiySbor для организации своего досуга.
